...
urlpatterns = [
    ...
    path("teacher/drives/<int:drive_id>/delete/", teacher_views.teacher_delete_drive, name="teacher_delete_drive"),
    ...
    path("quiz/confirm/", views.quiz_confirm, name="quiz_confirm"),
